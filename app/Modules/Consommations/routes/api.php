...
Route::group([
    ...
    Route::post('/consommations/deleteMultiple', [ConsommationsController::class, 'deleteMultiple'])->name('consommations.deleteMultiple');

    Route::get('/statistics', [ConsommationsController::class, 'getStatistics'])->name('statistics.get');
    Route::post('/consommations/store_2', [ConsommationsController::class, 'store_2']);
